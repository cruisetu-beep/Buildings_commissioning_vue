...
<template>
  <div class="page-view float-in">
    ...
    <div class="page-head">
      <div>
        ...
        <div class="page-subtitle">
          共 <b>34 条</b> 调适判定规则,分为
          <b class="mono" style="color: var(--series-c)">C 系 8 条(通用)</b>、
          <b class="mono" style="color: var(--series-d)">D 系 5 条(差异化)</b>、
          <b class="mono" style="color: var(--series-s)">S 系 21 条(业态专属,未启用)</b>。
          规则定义存储于 <code class="inline-code mono">T_ST_CxRule</code>。
        </div>
      </div>
      <div class="page-head-actions">
        <button class="btn ghost"><Icon name="upload" :size="14" /> 导入规则</button>
        <button class="btn primary"><Icon name="plus" :size="14" /> 新增规则</button>
      </div>
    </div>
    ...
    <div class="card glow rules-body">
      ...
      <SSeriesBanner v-if="sSeriesLocked" />
      ...
      <div class="table-footer">
        ...
        <div class="footer-meta mono">
          数据源:<code class="inline-code">T_ST_CxRule</code> · 34 rows · 最后更新 2026-06-29
        </div>
      </div>
    </div>
  </div>
